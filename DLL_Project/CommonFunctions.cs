...
namespace CommunityCoreLibrary
{
	...
	{
		public static bool ThingHasCategory( Thing t, ThingCategoryDef c )
		{
		...
		public static void SpawnThingOfCountAt( ThingDef of, int count, IntVec3 at )
		{
			while( count > 0 )
			{
		...
		public static void ReplaceThingWithThingOfCount( Thing oldThing, ThingDef of, int count )
		{
		...
		public static void RemoveDesignationOfAt( DesignationDef of, IntVec3 at )
		{
		...
		public static void RemoveDesignationOfOn( DesignationDef of, Thing on )
		{
